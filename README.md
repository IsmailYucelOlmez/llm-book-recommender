...
In order to create your vector database, you'll need to create a `.env` file in your root directory containing your Google Gemini API key (`GOOGLE_API_KEY`). Get a key at https://aistudio.google.com/apikey. Instructions on how to do this are part of the tutorial.

**Note:** This project uses Google Gemini embeddings instead of OpenAI. Install dependencies with `pip install -r requirements-gemini.txt`.
